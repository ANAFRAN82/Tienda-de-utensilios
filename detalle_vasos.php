...
$sql = "SELECT nombre, descripcion, Precio_por_Caja, id_Categoria, foto FROM productos WHERE id_Categoria = 3";
...
<head>
    ...
    <title>Vasos al Mayoreo - Tienda de Utensilios de Cocina</title>
    <style>
       body {
