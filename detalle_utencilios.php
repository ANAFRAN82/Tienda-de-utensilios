...
$sql = "SELECT nombre, descripcion, Precio_por_Caja, id_Categoria, foto FROM productos WHERE id_Categoria = 2";
...
<head>
    ...
    <title>Cubiertos al Mayoreo - Tienda de Utensilios de Cocina</title>
    <style>
        body {
